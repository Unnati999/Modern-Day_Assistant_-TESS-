...
def GoogleSearch(term):
    ...
    os.startfile('D:\\Tess\\DataBase\\ExtraPro\\start.py')
...
def Alarm(query):
    ...
    TimeHere=  open('D:\\Tess\\Data.txt','a')
    TimeHere.write(query)
    TimeHere.close()
    os.startfile("D:\\Tess\\DataBase\\ExtraPro\\Alarm.py")
...
def DownloadYouTube():
    ...
    def Download(link):
        ...
        video.download('D:\\Tess\\DataBase\\Youtube\\')
...
def SpeedTest():
    ...
    os.startfile("D:\\Tess\\DataBase\\Gui Programs\SpeedTestGui.py")
